...
const styles = StyleSheet.create({
  ...
  profileImage: tw`w-7/12 h-32 self-center mt-7 relative left-10 right-0 bottom-0 top-0`,
  imageStyle: tw`rounded-full`,
  profileEditIconContainer: tw`w-6/12 h-28 mt-1 justify-end items-end`,
